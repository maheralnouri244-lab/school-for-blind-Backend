...
<body>
  ...
  <main>
    ...
    <section class="login-card" aria-labelledby="login-heading">
      ...
      <form action="<?php echo e(route('dashboard.login')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Ghalia_\Downloads\newbackend\school-for-blind-Backend\school_for_blind\resources\views/auth/login.blade.php ENDPATH**/ ?>