                                ...
                                <div class="col-md-6 text-start" dir="rtl">
                                  ...
                                  <select name="assigned_department" class="form-select bg-transparent rounded-3"
                                    ...
                                    <option value="" <?php echo e(is_null($ticket->assigned_department) ? 'selected' : ''); ?>>اختر
                                      القسم...</option>
                                    <option value="Super Admin" <?php echo e($ticket->assigned_department == 'Super Admin' ? 'selected' : ''); ?>>المدير العام (Super Admin)</option>
                                    <option value="Academic Manager" <?php echo e($ticket->assigned_department == 'Academic Manager' ? 'selected' : ''); ?>>الموجّه الأكاديمي</option>
                                    <option value="Moderator" <?php echo e($ticket->assigned_department == 'Moderator' ? 'selected' : ''); ?>>مراقب المحتوى والبلاغات</option>
                                    <option value="Financial Manager" <?php echo e($ticket->assigned_department == 'Financial Manager' ? 'selected' : ''); ?>>المدير المالي (محاسب)</option>
