<header class="d-flex align-items-center justify-content-between p-3 border-bottom"
  ...
  <div class="d-flex align-items-center gap-4">
    ...
    <div class="d-flex align-items-center gap-2" style="cursor: pointer;">
      <img
        src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::guard('admin')->user()->role)); ?>&background=2d3748&color=fff"
        alt="Admin Avatar" class="rounded-circle" width="40" height="40">
      <div class="d-flex flex-column lh-1">
        <span class="fw-bold" style="color: var(--text-main);"><?php echo e(Auth::guard('admin')->user()->role); ?></span>
      </div>
...
</header><?php /**PATH C:\Users\Ghalia_\Downloads\newbackend\school-for-blind-Backend\school_for_blind\resources\views/partials/topbar.blade.php ENDPATH**/ ?>