...
@section('content')
        <div class="container-fluid py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="fw-bold m-0" style="color: var(--text-main);">إضافة امتحان / مذاكرة جديدة</h2>
                                ...
                                <div class="custom-card p-4 shadow-sm-hover border"
                                        ...
                                        <form action="{{ route('dashboard.exams.store') }}" method="POST">
                                                ...
                                                <div class="mb-4 text-start" dir="rtl">
                                                        <label for="title" class="form-label fw-bold text-muted mb-2">عنوان
                                                        ...
                                                        <input type="text" name="title" id="title"
                                                                ...
                                                                placeholder="مثال: مذاكرة الفصل الأول - رياضيات"
                                                                value="{{ old('title') }}">
                                                </div>

                                                <div class="mb-4 text-start" dir="rtl">
                                                        <label for="description"
                                                                class="form-label fw-bold text-muted mb-2">تفاصيل / نطاق
                                                                الامتحان</label>
                                                        <textarea name="description" id="description"
                                                                class="form-control bg-transparent rounded-3" rows="3"
                                                                style="color: var(--text-main); border: 1px solid var(--border-color);"
                                                ...
                                                <div class="row mb-4">
                                                        <div class="col-md-12 text-start" dir="rtl">
                                                                <label for="subject_id"
                                                                        class="form-label fw-bold text-muted mb-2">المادة <span
                                                                                class="text-danger">*</span></label>
                                                                <select name="subject_id" id="subject_id"
                                                                        class="form-select bg-transparent rounded-3" required
                                                                        style="color: var(--text-main); border: 1px solid var(--border-color);">
                                                ...
                                                <div class="row mb-5 g-4">
                                                        <div class="col-md-6 text-start" dir="rtl">
                                                                <label for="exam_date"
                                                                        class="form-label fw-bold text-muted mb-2">موعد الامتحان
                                                                        (التاريخ والوقت) </label>
                                                                <input type="datetime-local" name="exam_date" id="exam_date"
                                                                        class="form-control bg-transparent rounded-3"
                                                                        style="color: var(--text-main); border: 1px solid var(--border-color);"
                                                                        value="{{ old('exam_date') }}">
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 text-start" dir="rtl">
                                                                <label for="duration_minutes"
                                                                        class="form-label fw-bold text-muted mb-2">المدة
                                                                        (بالدقائق) <span class="text-danger">*</span></label>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center pt-4 border-top"
                                                        ...
                                                        <div>
                                                                <span class="badge px-3 py-2 rounded-pill fw-normal"
                                                                        ...
                                                                        <i class="fa-solid fa-lock me-1"></i> سيتم حفظ الامتحان
                                                                        كمسودة أولاً
                                                                </span>
                                                        </div>
                                                        <button type="submit"
                                                                class="btn px-5 py-2 rounded-pill fw-bold shadow-sm-hover"
