   ...
   <div class="col-lg-5">
    <div class="custom-card h-100 p-4">
     <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom"
      ...
      <button type="button" class="btn btn-sm btn-success fw-bold d-flex align-items-center gap-1" data-bs-toggle="modal"
         ...
         <tr style="border-bottom: 1px solid var(--border-color);">
          ...
          <td class="py-3 text-start">
           <button type="button" class="btn btn-sm btn-outline-danger"
            onclick="confirmDetachTeacher({{ $teacher->id }}, '{{ $teacher->full_name }}')" title="إلغاء ربط من الشعبة">
   ...
   <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
    ...
    <form action="{{ route('classes.teachers.attach', $class->id) }}" method="POST" id="attachTeacherForm">
         ...
         <div class="d-flex align-items-center gap-3">
          ...
          <div>
           ...
           <div class="d-flex flex-wrap gap-1 align-items-center">
            @forelse($teacher->subjects()->get() as $subject)
             <span class="badge bg-soft-info text-info font-normal" style="font-size: 0.75rem;">{{ $subject->name }}</span>
            @empty
     ...
     <div class="modal-header border-top pt-3 d-flex justify-content-between"
      ...
      <button type="submit" class="btn btn-success px-4 fw-bold d-flex align-items-center gap-2" id="submitAttachBtn"
   ...
   <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
    ...
    <form action="{{ route('classes.students.transfer', $class->id) }}" method="POST">
     ...
     <div class="modal-body py-4">
      ...
      <div class="alert bg-soft-warning border-warning text-warning d-flex align-items-center gap-2 mb-0" role="alert">
