                        ...
                        @forelse($pastExam->questions as $question)
                            <div class="p-4 rounded-4 shadow-sm-hover" style="background-color: var(--hover-bg); border: 1px solid var(--border-color); transition: all 0.2s;">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    ...
                                    <form action="{{ route('dashboard.past-exams.questions.detach', [$pastExam->id, $question->id]) }}" method="POST"
                                ...
                                @elseif($question->type == 'TF')
                                    <div class="p-3 rounded-3 fw-bold d-inline-flex align-items-center gap-2"
                                        ...
                                        <i class="fa-solid fa-check-double"></i> الإجابة الصحيحة: {{ $question->correct_answer == 'T' ? 'صح (True)' : 'خطأ (False)' }}
                                    </div>
                                @else
