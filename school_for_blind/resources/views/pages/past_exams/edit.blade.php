...
@section('content')
  <div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="fw-bold m-0" style="color: var(--text-main);">تعديل الدورة الوزارية</h2>
        ...
        <div class="custom-card p-4 shadow-sm-hover border"
          ...
          <form action="{{ route('dashboard.past-exams.update', $pastExam->id) }}" method="POST"
            ...
            <div class="row mb-4 g-4">
              ...
              <div class="col-md-6 text-start" dir="rtl">
                ...
                <select name="session" id="session" class="form-select bg-transparent rounded-3" required
                  style="color: var(--text-main); border: 1px solid var(--border-color);">
                  <option value="first" {{ old('session', $pastExam->session) == 'first' ? 'selected' : '' }}>الأولى
                  </option>
                  <option value="second" {{ old('session', $pastExam->session) == 'second' ? 'selected' : '' }}>الثانية
                  </option>
                  <option value="complementary" {{ old('session', $pastExam->session) == 'complementary' ? 'selected' : '' }}>تكميلية</option>
                </select>
              </div>
            ...
            @if($pastExam->voice_solution_path)
              <div class="p-3 mb-5 rounded-4 d-flex flex-column gap-2 text-start" dir="rtl"
                ...
                <audio controls class="w-100 mt-1" style="height: 40px;">
            ...
            {{-- قسم الأزرار وحالة الدورة السفلية --}}
              ...
              <div>
                ...
                @else
                  <span class="badge px-3 py-2 rounded-pill fw-normal"
                    ...
                    <i class="fa-solid fa-earth-americas me-1"></i> الحالة: منشورة للطلاب
                  </span>
                @endif
              </div>
