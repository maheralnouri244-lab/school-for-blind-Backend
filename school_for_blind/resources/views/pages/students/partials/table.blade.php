<div class="table-responsive rounded-4 border"
 ...
 <table class="table table-hover-custom align-middle mb-0" style="color: var(--text-main);">
  <thead style="background-color: var(--hover-bg);">
   <tr>
    {{-- استخدمنا text-start للمحاذاة لليمين، و px-4 لترك مسافة تنفس (Padding) من الحفة --}}
  ...
  <tbody>
   @forelse($students as $student)
    <tr style="border-bottom: 1px solid var(--border-color); cursor: pointer;" data-bs-toggle="modal"
     ...
     {{-- خلية الرقم (عملناها بالمنتصف مع ltr لتحافظ على شكل الرقم) --}}
     ...
     <td class="py-3 px-4 text-start">
      ...
      <span
       ...
       {{-- نقطة صغيرة ملونة بتعطي حركة حلوة للحالة --}}
   ...
   @empty
    <tr>
     <td colspan="4" class="text-center py-5 text-muted">
      ...
      لا يوجد طلاب مسجلين لعرضهم حالياً.
     </td>
    </tr>
   @endforelse
  </tbody>
